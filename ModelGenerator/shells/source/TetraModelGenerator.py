...
class CubeModelGenerator(ModelGeneratorBase):
    ...
    def _WriteBegin(self, txtfile):
        ...
        txtfile.Write("1,Mat-1,LE,3E10,77.3E9,7850,0.3\r\n")
        txtfile.Write("##\r\n")
        #section
    ...
    def _WriteEnd(self, txtfile):
        ...
        txtfile.Write("CONSTRAINT, BC_1\r\n")
        txtfile.Write("##\r\n")

        txtfile.Write("/STEP/\r\n")
        txtfile.Write("step-1-static, GENERAL, STATIC, 0.0001, 1, 100, 100\r\n")
        txtfile.Write("step-1-static, LOAD, gravity_set\r\n")
        txtfile.Write("##\r\n")